...
import { BLEED_STEPS } from "@/lib/resqnet-data";
import { Volume2 } from "lucide-react";

export const Route = createFileRoute("/bleeding")({
  head: () => ({ meta: [{ title: "Bleeding Control — ResQNet" }] }),
  component: Bleeding,
});
  ...
  return (
    <DashboardLayout>
      ...
      <TopBar
        ...
        subtitle={`Step ${i + 1} of ${BLEED_STEPS.length}`}
        right={
